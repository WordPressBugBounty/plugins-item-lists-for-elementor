...
<div class="ile-gradient-ordered-bullet-style">
    ...
    <?php $item_lists_alignment = $settings['list_items_number_box_alignment'];
    foreach ($settings['gradient_ordered_item_lists'] as $item_lists_items => $item_lists_item) {
        ...
        <?php 
        $item_lists_allowed_alignments = ['left', 'center', 'right'];
        $item_lists_validated_alignment = in_array($item_lists_alignment ?? 'left', $item_lists_allowed_alignments, true) ? $item_lists_alignment : 'left';
        ?>
