...
<div class="ile-timeline-bullet-style" style="direction:<?php echo esc_attr($item_lists_direction) ?>;"><?php
    foreach ($settings['timeline_item_lists'] as $item_lists_items => $item_lists_item) {
        ...
        <div class="ile-container-holder">
            ...
            if($item_lists_item['timeline_list_items_display_icon'] === 'icon') { ?>
