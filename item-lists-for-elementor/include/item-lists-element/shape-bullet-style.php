...
<div class="ile-shape-bullet-style" style="direction:<?php echo esc_attr($direction); ?>;"><?php
        ...
        <div class="ile-container-icon-line">
            <div class="ile-icon-box"><?php 
                if($icon_box == 'diamond-icon-style') { 
                    $diamond_svg = '<svg class="ile-icon-shape" viewBox="0 0 94 94" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.41423 46.528L46.53 1.41421L91.6418 46.528L46.528 91.6418L1.41423 46.528Z" stroke="black" stroke-width="1"/>
                    </svg>';
                    echo wp_kses_post($diamond_svg);
                }
                else if($icon_box == 'circle-icon-style') { 
                    $circle_svg = '<svg class="ile-icon-shape" viewBox="0 0 67 67" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    echo wp_kses_post($circle_svg);
                }
                else { 
                    $square_svg = '<svg class="ile-icon-shape" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.5 0.5H49.5V49.5H0.5V0.5Z" stroke="black"/>
                    </svg>';
                    echo wp_kses_post($square_svg);
                }
