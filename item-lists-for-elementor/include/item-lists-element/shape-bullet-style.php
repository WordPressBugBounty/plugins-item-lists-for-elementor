...
<div class="ile-shape-bullet-style" style="direction:<?php echo esc_attr($item_lists_direction); ?>;"><?php
    ...
    <div class="ile-container-holder">
        <div class="ile-container-icon-line">
            <div class="ile-icon-box"><?php 
                if($item_lists_icon_box == 'diamond-icon-style') { 
                ...
                else if($item_lists_icon_box == 'circle-icon-style') { 
                ...
                if($item_lists_item['shape_list_items_display_icon'] === 'icon') {  
                    Icons_Manager::render_icon($item_lists_item['shape_list_items_icon'], [ 'aria-hidden' => 'true', 'class' => 'ile-icon']);
                } ?>
            </div>
